...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private static final int EXISITNG_PET_LOADER =0 ;
    ...
    /** For detecting changes in edit page **/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentPetUri == null) {
            ...
            getLoaderManager().initLoader(EXISITNG_PET_LOADER, null, this);
        }
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        mGender = PetEntry.GENDER_MALE;// Male [outerClass.innerClass.staticVariableName] imported OuterClass
    ...
    /** Get user input from editor and save new pet in the database
     */
    private void savePet() {

        // Read from input fields
        // Use trim to eliminate leading or trailing white space
        String nameString = mNameEditText.getText().toString().trim(); // 'trim' deletes any leading or trailing whitespce
    ...
    //Called when insert mode is selected which invalidates the delete menu
    @Override
